...
<head>
    ...
    <title>Signup to Galaxify</title>
        ...
        <main class="flex h-screen">
            <section class="flex flex-col items-center justify-center flex-1 py-10">
                <div class="flex-col sm:w-420 flex-center">
                    ...
                    <h2 class="pt-3 h3-bold md:h2-bold sm:pt-8">Create a new account</h2>
                    <p class="mt-2 text-light-3 small-medium md:base-regular">To use Galaxify, please enter your details</p>
                    <form class="flex flex-col w-full gap-5 mt-4" action="<?php echo Path::base(); ?>/signup" method="post">
                        <div class="space-y-2">
                            <label class="text-sm font-medium leading-none peer-disabled:cursor-not-allowed peer-disabled:opacity-70" for=":r0:-form-item">Name</label>
                            <input type="text" class="flex h-10 w-full rounded-md border border-input bg-background px-3 py-2 text-sm ring-offset-background file:border-0 file:bg-transparent file:text-sm file:font-medium file:text-foreground placeholder:text-muted-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50 shad-input" name="name" id=":r0:-form-item" aria-describedby=":r0:-form-item-description" aria-invalid="false" value="" required>
                        </div>
                        <div class="space-y-2">
                            <label class="text-sm font-medium leading-none peer-disabled:cursor-not-allowed peer-disabled:opacity-70" for=":r0:-form-item">Username</label>
                            <input type="text" class="flex h-10 w-full rounded-md border border-input bg-background px-3 py-2 text-sm ring-offset-background file:border-0 file:bg-transparent file:text-sm file:font-medium file:text-foreground placeholder:text-muted-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50 shad-input" name="username" id=":r0:-form-item" aria-describedby=":r0:-form-item-description" aria-invalid="false" value="" required>
                        </div>
                        <div class="space-y-2">
                        ...
                        <button class="inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&amp;_svg]:pointer-events-none [&amp;_svg]:size-4 [&amp;_svg]:shrink-0 bg-primary text-primary-foreground hover:bg-primary/90 h-10 px-4 py-2 shad-button_primary" type="submit">Sign up</button>
                        <p class="mt-2 text-center text-small-regular text-light-2">Already have an account?<a class="text-primary-500 text-small-semibold" href="<?php echo Path::base(); ?>/login/"> Log in</a></p>
                    </form>
                </div>
            </section>
